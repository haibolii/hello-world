...
\subsubsection*{Squared Exponential Kernel Function}
...
\end{equation}
the parameter $l$ is the \textit{characteristic length-scale} and $\sigma$ controls the magnitude of function value. The \textit{squared exponential} kernel function is also known as the \textit{radial basis function}. 

\subsubsection*{Matern Class of Kernel Functions}
